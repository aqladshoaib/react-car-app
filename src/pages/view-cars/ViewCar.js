  ...
  return (
    <div>
     <div className="sub-heading"> This page is for viewing cars </div>
      ...
      <div>There are so many ways to buy your car, it can be overwhelming. At Motorway, we’re focused on building the best way. Unlike your other options, we won’t make you choose between price and convenience – you can have both, with no extra effort. We’ll guide you through the process to get a great result.
